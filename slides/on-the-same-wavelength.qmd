...
::: {.rule-line}
Algebra did it: 12,000 core-hours became 1,150, and the same reasoning cut the sample the
study needs.
:::
...
Land on the last line, and say the half that is not printed: the cluster did not make these
analyses faster, it made them possible.
:::
...
::: src
**Acknowledgement:** *"The authors would like to acknowledge the use of the
...
::: src
Software and model versions are given on the slides that use them. The full list, with links,
